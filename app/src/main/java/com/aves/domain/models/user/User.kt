package com.aves.domain.models.user

import com.aves.domain.models.common.ChildLinks
import com.aves.domain.models.common.ProfileImage
import com.aves.domain.models.common.Social
...
data class User(
    ...
    @SerializedName("links") var links: ChildLinks? = null,
