...
/**
 * An interceptor which logs request and response information. Can be applied as an
 * [application interceptor][OkHttpClient.interceptors] or as a [OkHttpClient.networkInterceptors].
 * The logging format in this class is copied from [okhttp3.logging.HttpLoggingInterceptor]
 */
...
class AuthInterceptor @Inject constructor() : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        for (i in 0 until resHeaders.size) {
        ...
        if (!response.promisesBody()) {
            ...
            if ("gzip".equals(resHeaders["Content-Encoding"], ignoreCase = true)) {
